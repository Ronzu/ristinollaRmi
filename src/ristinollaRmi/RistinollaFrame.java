	...
	class GameListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				boolean alive = game.getOpponent(this.player).isAlive(); // tämä heittää poikkeuksen jos vastustaja lähtee
				...
				JOptionPane.showMessageDialog(null,"Opponent left the game",null,JOptionPane.OK_OPTION); //hoidetaan poikkeus tällä
				System.exit(0);
			} // try
